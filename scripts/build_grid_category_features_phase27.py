...
Prerequisites:
    ...
    python scripts/generate_hex_grid_phase27.py --radius-m 500
    python scripts/import_osm_business_features_phase27.py --truncate
    python scripts/import_population_density_phase27.py data/raw/rwa_pd_2020_1km_ASCII_XYZ.csv --truncate
    python scripts/import_population_count_phase27.py data/raw/population_count_6456351076777895603.csv --truncate
"""
